  ...
  return (
    <>
      ...
      <div className="flex-container">
        <img id="pfp" src="assets/my%20pfp.png" alt="Rajveer PFP" />
      ...
      <div className="certificates" id="certificates">
        ...
        <div className="cert-card">
          ...
          <img
            className="cert"
            src="assets/red-hat-openshift-applications.jpg"
        ...
        <div className="cert-card">
          ...
          <img className="cert" src="assets/dbms.jpg" alt="DBMS" />
